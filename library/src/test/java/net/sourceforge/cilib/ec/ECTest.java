...
public class ECTest {
    ...
    public void algorithmTest() {
        ...
        try {
            ...
            Assert.assertThat(ec.getBestSolution().getFitness().getValue(), is(89.30612303129882));
        } finally {
    ...
    public void deTest() {
        ...
        try {
            ...
            Assert.assertThat(ec.getBestSolution().getFitness().getValue(), is(142.24054954778484));
        } finally {
            Seeder.setSeederStrategy(seedStrategy);
        }
    }
