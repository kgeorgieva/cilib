...
public class ParameterizedIndividual extends Individual{
    ...
    /*
     * Default constructor for ParameterizedIndividual
     */
    public ParameterizedIndividual() {
         super();
    ...
    /*
     * Copy constructor for ParameterizedIndividual
     * @param copy The ParameterizedIndividual to be copied
     */
    public ParameterizedIndividual(ParameterizedIndividual copy) {
         super(copy);
    ...
    /*
     * Clone method for ParameterizedIndividual
     * @return A new instance of this ParameterizedIndividual
     */
    @Override
    public ParameterizedIndividual getClone() {
        return new ParameterizedIndividual(this);
    }
    ...
    public void initialise(Problem problem) {
        ...
        initialisationStrategy.initialize(EntityType.CANDIDATE_SOLUTION, parameterHoldingIndividual);
